...
// que foram alinhadas com o backend C#, assumindo que o endpoint para busca por documento
// no C# é GET /api/clientes/documento/{documento}.
'use client';
...
export default function BuscarUsuarioPage() {
    ...
    const handleInputChange = (e: ChangeEvent<HTMLInputElement>) => {
        ...
        if (tipoBusca === 'documento') {
            valor = valor.replace(/\D/g, '').slice(0, 14); // Limita para 14 (CNPJ)
    ...
    const handleBuscar = async (e: FormEvent) => {
        ...
        if (tipoBusca === 'id') {
            ...
            // setLoading será false quando a nova página carregar ou se houver erro na navegação.
            // Não é necessário setar setLoading(false) aqui explicitamente para este fluxo.
            ...
            try {
                ...
                if (usuarioEncontrado && usuarioEncontrado.idCliente) {
                    ...
                    // Este caso pode não ser atingido se a API retornar 404 e handleApiResponse lançar erro.
