...
export interface Page<T> {
  ...
  export interface NasaEonetGeometryDTO {
    ...
    /**
     * As coordenadas podem ser de vários formatos (Point como [lon, lat], Polygon como [[...]] etc.).
     * Para garantir que não se use `any`, declara-se como `unknown`. Use checagens nominais ao consumi-las.
     */
    coordinates: unknown;
  }
